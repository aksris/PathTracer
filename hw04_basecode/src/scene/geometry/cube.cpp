...
Intersection Cube::SampleLight(float x, float y, glm::vec3 ray_origin, IntersectionEngine* i_engine){
...
Intersection Cube::GetIntersection(Ray r)
{
    ...
    if(t_n < t_f && t_n >= 0){
        ...
        glm::vec3 normal = glm::vec3(GetCubeNormal(P));
        if(normal == glm::vec3(1.0f, 0.0f, 0.0f)){
            result.tangent = glm::vec3(0.0f, 1.0f, 0.0f);
            result.bitangent = glm::vec3(0.0f, 0.0f, 1.0f);
        }
        else if(normal == glm::vec3(0.0f, 1.0f, 0.0f)){
            result.tangent = glm::vec3(0.0f, 0.0f, 1.0f);
            result.bitangent = glm::vec3(1.0f, 0.0f, 0.0f);
        }
        else if(normal == glm::vec3(0.0f, 0.0f, 1.0f)){
            result.tangent = glm::vec3(1.0f, 0.0f, 0.0f);
            result.bitangent = glm::vec3(0.0f, 1.0f, 0.0f);
        }
        ...
        result.bitangent = glm::normalize(glm::vec3(transform.T() * glm::vec4(result.bitangent, 0.0f)));
        result.tangent = glm::normalize(glm::vec3(transform.T() * glm::vec4(result.tangent, 0.0f)));
